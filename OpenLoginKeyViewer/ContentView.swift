...
struct ContentView: View {
    ...
    var body: some View {
        if authManager.currentUser != nil{
            let manager:BlockChainManagerProtocol = authManager.currentBlockChain == .ethereum ? EthManager(authManager: authManager, network: $web3AuthManager.network)! : SolanaManager(authManager: authManager)!
